...
class GenericService(models.Model):
    ...
    tag_category_ids = fields.Many2many(
        'generic.tag.category', 'request_service_tag_category_rel',
        'service_id', 'category_id', string='Tag Categories',
        domain=[('model_id.model', '=', 'request.request')],
        help='Restrict available tags for requests of this service '
