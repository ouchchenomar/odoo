...
class ResConfigSettings(models.TransientModel):
    ...
    group_request_use_service_groups = fields.Boolean(
        group='base.group_user,base.group_portal,base.group_public',
        implied_group='generic_request.'
                      'group_request_use_service_groups')
    group_request_use_kind = fields.Boolean(
        group='base.group_user,base.group_portal,base.group_public',
        implied_group='generic_request.'
                      'group_request_use_kind')
    request_autoset_unsubscribe_prev_assignee = fields.Boolean(
        related='company_id.request_autoset_unsubscribe_prev_assignee',
        readonly=False
    )
    request_mail_use_special_name = fields.Boolean(
        config_parameter='generic_request.request_mail_use_special_name',
        help='Enabling this option will enforce using special request name'
             ' value for subject for most request emails.'
             ' The subject of the message will consist of the name'
             ' of the request and the subject of the email from which'
             ' this request was created, separated by the "|" character.'
             ' Example: "Req-112023-0049 | Help setting up the Helpdesk"')
