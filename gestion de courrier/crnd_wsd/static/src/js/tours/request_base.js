odoo.define('crnd_wsd.tour_request_base', function (require) {
    ...
    tour.register('crnd_wsd_tour_request_base', {
        ...
        {
            content: "Check on page opened requests",
            trigger: ".wsd_requests a[href='/requests/open'].active",
        },
        {
        ...
        },
        {
            ...
            trigger: "#discussion .o_portal_chatter_message " +
                "h1:containsExact('Test comment')",
        },
        {
